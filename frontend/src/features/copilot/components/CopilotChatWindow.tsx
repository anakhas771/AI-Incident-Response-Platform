...
export const CopilotChatWindow: React.FC<CopilotChatWindowProps> = React.memo(
  ({
    ...
    return (
      <div className="relative flex h-full min-h-0 min-w-0 flex-1 flex-col overflow-hidden bg-zinc-950 text-zinc-100">
        ...
        <div
          className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-3 py-5 sm:px-6 sm:py-6 lg:px-8"
          role="log"
          ...
          {isLoadingMessages ? (
            ...
            <div className="flex h-full min-h-[420px] items-center justify-center">
              <div className="max-w-xl px-5 text-center sm:px-6">
                <div className="relative mx-auto flex h-14 w-14 items-center justify-center rounded-2xl border border-indigo-400/20 bg-indigo-500/10 text-indigo-300 shadow-[0_0_35px_rgba(99,102,241,0.16)]">
                  <div className="absolute inset-0 rounded-2xl bg-cyan-400/10 blur-xl" />
                  <Shield className="relative h-6 w-6" />
                </div>
                <p className="mt-5 text-[10px] font-semibold uppercase tracking-[0.22em] text-indigo-300/60">
                ...
                <div className="mt-6 grid gap-2 text-left sm:grid-cols-2">
                  {[
                    ...
                    <button
                      ...
                      className="group rounded-xl border border-zinc-800/90 bg-zinc-900/55 px-3.5 py-3 text-left text-xs leading-5 text-zinc-400 shadow-[0_4px_20px_rgba(0,0,0,0.12)] transition-all duration-300 hover:-translate-y-0.5 hover:border-indigo-400/25 hover:bg-indigo-500/[0.08] hover:text-zinc-200 hover:shadow-[0_8px_30px_rgba(99,102,241,0.08)]"
                    >
                      {q}
                    </button>
                  ))}
            ...
            <div className="mx-auto w-full max-w-4xl space-y-7 pb-6">
