...
export const CopilotChatWindow: React.FC<CopilotChatWindowProps> = React.memo(
  ({
    ...
    return (
      <div className="relative flex min-w-0 flex-1 flex-col bg-zinc-950 text-zinc-100">
        <header className="flex shrink-0 items-center justify-between border-b border-zinc-800/80 bg-zinc-950 px-5 py-3.5">
          <div className="flex min-w-0 items-center gap-3">
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md border border-zinc-800 bg-zinc-900 text-zinc-500">
        ...
        {error && (
          <div
            className="flex items-center justify-between border-b border-rose-900/60 bg-rose-950/30 px-5 py-2.5 text-xs text-rose-300"
            role="alert"
          >
                ...
                <div className="mt-6 grid gap-2 text-left sm:grid-cols-2">
                  {[
                    ...
                    <button
                      ...
                      className="rounded-md border border-zinc-800 bg-zinc-900/40 px-3 py-2.5 text-xs leading-5 text-zinc-400 transition-colors hover:border-zinc-700 hover:bg-zinc-900 hover:text-zinc-200"
                    >
                      {q}
                    </button>
                  ))}
