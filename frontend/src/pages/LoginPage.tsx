  ...
  return (
    <div className="h-screen overflow-hidden bg-[#09090b] flex items-center justify-center p-3 sm:p-4 relative text-zinc-100 select-none">
      ...
      >
        ...
        {error && (
          <div role="alert" className="mb-3 rounded-lg border border-rose-500/40 bg-rose-500/10 px-3 py-2 text-[11px] sm:text-xs text-rose-300 flex items-center gap-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-2.5 sm:space-y-3">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <label className="text-[10px] sm:text-[11px] font-semibold text-zinc-300 uppercase tracking-wider">Password</label>
              <Link to="/forgot-password" className="text-[10px] sm:text-xs text-indigo-400 hover:text-indigo-300 transition-colors">Forgot?</Link>
            </div>
            <div className="relative">
        ...
        <div className="mt-3 sm:mt-4 pt-3 border-t border-zinc-800/80 text-center text-[10px] sm:text-xs text-zinc-400">
          ...
          <Link to="/register" className="text-indigo-400 hover:text-indigo-300 font-medium">Register Organization</Link>
        </div>
      </motion.div>
    </div>
  );
