...
export const SplashPage: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 bg-[#09090b] flex flex-col items-center justify-center text-zinc-100 z-50 select-none px-4">
      <div className="relative flex flex-col items-center text-center">
        ...
        <motion.h1
          ...
          className="text-2xl sm:text-3xl font-bold tracking-tight text-white flex items-center justify-center gap-2 flex-wrap"
        >
          OpsMind
        ...
        <motion.p
          ...
          className="text-xs sm:text-sm font-mono text-zinc-400 mt-2 max-w-md"
        >
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 mt-8 text-[11px] font-mono text-zinc-400"
        >
