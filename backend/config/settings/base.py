...
COPILOT_LLM_CONFIG = {
    "PROVIDER": os.environ.get("COPILOT_LLM_PROVIDER", "mock").strip().lower(),
    "API_KEY": os.environ.get("OPENAI_API_KEY", ""),
    "MODEL": os.environ.get("COPILOT_LLM_MODEL", "gpt-4o-mini").strip(),
    "TEMPERATURE": float(os.environ.get("COPILOT_LLM_TEMPERATURE", "0.2")),
    "MAX_TOKENS": int(os.environ.get("COPILOT_LLM_MAX_TOKENS", "2048")),
    "TIMEOUT": int(os.environ.get("COPILOT_LLM_TIMEOUT", "60")),
    "MAX_RETRIES": int(os.environ.get("COPILOT_LLM_MAX_RETRIES", "2")),
